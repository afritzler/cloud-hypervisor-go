...
const (
	VmInfoStateCreated VmInfoState = "Created"

	VmInfoStatePaused VmInfoState = "Paused"

	VmInfoStateRunning VmInfoState = "Running"

	VmInfoStateShutdown VmInfoState = "Shutdown"
)
...
type VmInfo struct {
	...
	DeviceTree       *VmInfo_DeviceTree `json:"device_tree,omitempty"`
	MemoryActualSize *int64             `json:"memory_actual_size,omitempty"`
	State            VmInfoState        `json:"state"`
}

// VmInfo_DeviceTree defines model for VmInfo.DeviceTree.
type VmInfo_DeviceTree struct {
	AdditionalProperties map[string]DeviceNode `json:"-"`
}
...
// PutVmAddDeviceJSONBody defines parameters for PutVmAddDevice.
type PutVmAddDeviceJSONBody DeviceConfig

// PutVmAddDiskJSONBody defines parameters for PutVmAddDisk.
type PutVmAddDiskJSONBody DiskConfig

// PutVmAddFsJSONBody defines parameters for PutVmAddFs.
type PutVmAddFsJSONBody FsConfig

// PutVmAddNetJSONBody defines parameters for PutVmAddNet.
type PutVmAddNetJSONBody NetConfig

// PutVmAddPmemJSONBody defines parameters for PutVmAddPmem.
type PutVmAddPmemJSONBody PmemConfig

// PutVmAddUserDeviceJSONBody defines parameters for PutVmAddUserDevice.
type PutVmAddUserDeviceJSONBody VmAddUserDevice

// PutVmAddVdpaJSONBody defines parameters for PutVmAddVdpa.
type PutVmAddVdpaJSONBody VdpaConfig

// PutVmAddVsockJSONBody defines parameters for PutVmAddVsock.
type PutVmAddVsockJSONBody VsockConfig

// PutVmCoredumpJSONBody defines parameters for PutVmCoredump.
type PutVmCoredumpJSONBody VmCoredumpData

// CreateVMJSONBody defines parameters for CreateVM.
type CreateVMJSONBody VmConfig

// PutVmReceiveMigrationJSONBody defines parameters for PutVmReceiveMigration.
type PutVmReceiveMigrationJSONBody ReceiveMigrationData

// PutVmRemoveDeviceJSONBody defines parameters for PutVmRemoveDevice.
type PutVmRemoveDeviceJSONBody VmRemoveDevice

// PutVmResizeJSONBody defines parameters for PutVmResize.
type PutVmResizeJSONBody VmResize

// PutVmResizeZoneJSONBody defines parameters for PutVmResizeZone.
type PutVmResizeZoneJSONBody VmResizeZone

// PutVmRestoreJSONBody defines parameters for PutVmRestore.
type PutVmRestoreJSONBody RestoreConfig

// PutVmSendMigrationJSONBody defines parameters for PutVmSendMigration.
type PutVmSendMigrationJSONBody SendMigrationData

// PutVmSnapshotJSONBody defines parameters for PutVmSnapshot.
type PutVmSnapshotJSONBody VmSnapshotConfig

// PutVmAddDeviceJSONRequestBody defines body for PutVmAddDevice for application/json ContentType.
type PutVmAddDeviceJSONRequestBody PutVmAddDeviceJSONBody

// PutVmAddDiskJSONRequestBody defines body for PutVmAddDisk for application/json ContentType.
type PutVmAddDiskJSONRequestBody PutVmAddDiskJSONBody

// PutVmAddFsJSONRequestBody defines body for PutVmAddFs for application/json ContentType.
type PutVmAddFsJSONRequestBody PutVmAddFsJSONBody

// PutVmAddNetJSONRequestBody defines body for PutVmAddNet for application/json ContentType.
type PutVmAddNetJSONRequestBody PutVmAddNetJSONBody

// PutVmAddPmemJSONRequestBody defines body for PutVmAddPmem for application/json ContentType.
type PutVmAddPmemJSONRequestBody PutVmAddPmemJSONBody

// PutVmAddUserDeviceJSONRequestBody defines body for PutVmAddUserDevice for application/json ContentType.
type PutVmAddUserDeviceJSONRequestBody PutVmAddUserDeviceJSONBody

// PutVmAddVdpaJSONRequestBody defines body for PutVmAddVdpa for application/json ContentType.
type PutVmAddVdpaJSONRequestBody PutVmAddVdpaJSONBody

// PutVmAddVsockJSONRequestBody defines body for PutVmAddVsock for application/json ContentType.
type PutVmAddVsockJSONRequestBody PutVmAddVsockJSONBody

// PutVmCoredumpJSONRequestBody defines body for PutVmCoredump for application/json ContentType.
type PutVmCoredumpJSONRequestBody PutVmCoredumpJSONBody
...
// Setter for additional properties for VmCounters
func (a *VmCounters) Set(fieldName string, value struct {
	AdditionalProperties map[string]int64 `json:"-"`
}) {
	if a.AdditionalProperties == nil {
...
// Override default JSON handling for VmCounters to handle AdditionalProperties
func (a *VmCounters) UnmarshalJSON(b []byte) error {
...
// Override default JSON handling for VmCounters to handle AdditionalProperties
func (a VmCounters) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for VmInfo_DeviceTree. Returns the specified
// element and whether it was found
func (a VmInfo_DeviceTree) Get(fieldName string) (value DeviceNode, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for VmInfo_DeviceTree
func (a *VmInfo_DeviceTree) Set(fieldName string, value DeviceNode) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]DeviceNode)
	}
	a.AdditionalProperties[fieldName] = value
}

// Override default JSON handling for VmInfo_DeviceTree to handle AdditionalProperties
func (a *VmInfo_DeviceTree) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for VmInfo_DeviceTree to handle AdditionalProperties
func (a VmInfo_DeviceTree) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
type ClientInterface interface {
	// PutVmAddDevice request with any body
	...
	// PutVmAddDisk request with any body
	...
	// PutVmAddFs request with any body
	...
	// PutVmAddNet request with any body
	...
	// PutVmAddPmem request with any body
	...
	// PutVmAddUserDevice request with any body
	...
	// PutVmAddVdpa request with any body
	...
	// PutVmAddVsock request with any body
	...
	// PutVmCoredump request with any body
	...
	// PutVmReceiveMigration request with any body
	...
	// PutVmRemoveDevice request with any body
	...
	// PutVmResize request with any body
	...
	// PutVmResizeZone request with any body
	...
	// PutVmRestore request with any body
	...
	// PutVmSendMigration request with any body
	...
	// PutVmSnapshot request with any body
